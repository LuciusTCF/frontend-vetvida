  ...
  return (
    <div>
      ...
      <p className="p-3">
        ...
        cualquier pregunta que pueda tener. No dudes en comunicarte con nosotros
            ...
            <section>
              ...
              <fieldset className="form-floating mt-3">
                <textarea
                  ...
                  {...register("message", {
                    required:
                      "Este campo es requerido,por favor escriba su comentario.",
                    minLength: {
                      value: 10,
              ...
              <div className="mt-3  d-grid">
                <button
                  className=" btnContact btn  shadow-lg fw-bold text-uppercase border-danger-subtle border-3"
                  type="submit"
                >
                  Enviar
                </button>
