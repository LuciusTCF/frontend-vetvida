    ...
    <div>
      ...
      <div className="position-relative">
        ...
        <div className="overlay overlay-home d-flex h-100 align-items-center text-white position-absolute mx-3">
          <p>
            Brindamos servicios <br /> dignos de calidez <br /> y excelencia
          </p>
        </div>
      </div>
      ...
      <div className="servicios d-flex">
        <p className="mx-5 my-4">
          ...
          <br />
          <br />
          Consulta general <br /> Medicina preventiva: vacunación y
          desparasitación <br />
          Limpieza dental <br /> Esterilizaciones <br /> Cirugías <br /> Rayos x
          <br />
        ...
        <div className="col-9">
          <div>
            <div className="row mx-2 my-2 g-3 profesionales">
              <p>
                <b>
                  Tus mascotas en las mejores manos.. nuestros profesionales:
                </b>
              </p>
